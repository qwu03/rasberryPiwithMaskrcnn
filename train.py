...
class ToolConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + tool classes
...
class ToolDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        for i in range(1,len(CLASS_NAMES)):
            self.add_class('balloon',i,CLASS_NAMES[i])

        # self.add_class("balloon", 1, "hammer")
        # self.add_class("balloon", 2, "phone")
